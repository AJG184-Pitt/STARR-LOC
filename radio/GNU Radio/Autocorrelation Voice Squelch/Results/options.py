...
class options(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._rf_gain_range = qtgui.Range(0, 64, 1, 0, 200)
        ...
        self.blocks_wavfile_sink_0_0_0 = blocks.wavfile_sink(
            '/home/adam-nichols/Documents/Pitt/ECE 1896/Git repo/STARR-LOC/radio/GNU Radio/Autocorrelation Voice Squelch/Results/Recordings/base.wav',
            2,
            audio_samp_rate,
            blocks.FORMAT_WAV,
        ...
        self.blocks_wavfile_sink_0_0 = blocks.wavfile_sink(
            '/home/adam-nichols/Documents/Pitt/ECE 1896/Git repo/STARR-LOC/radio/GNU Radio/Autocorrelation Voice Squelch/Results/Recordings/demod.wav',
            1,
            audio_samp_rate,
            blocks.FORMAT_WAV,
            blocks.FORMAT_PCM_16,
        ...
        self.blocks_wavfile_sink_0 = blocks.wavfile_sink(
            '/home/adam-nichols/Documents/Pitt/ECE 1896/Git repo/STARR-LOC/radio/GNU Radio/Autocorrelation Voice Squelch/Results/Recordings/trigger.wav',
            1,
            audio_samp_rate,
            blocks.FORMAT_WAV,
            blocks.FORMAT_PCM_16,
        ...
        self.connect((self.blocks_complex_to_float_0, 0), (self.blocks_wavfile_sink_0_0_0, 0))
        self.connect((self.blocks_complex_to_float_0, 1), (self.blocks_wavfile_sink_0_0_0, 1))
        ...
        self.connect((self.blocks_repeat_0, 0), (self.blocks_wavfile_sink_0, 0))
